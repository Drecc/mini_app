...
#include "mini_app/core/application/common/manifest_handlers/permissions_handler.h"
#include "mini_app/core/application/common/manifest_handlers/widget_handler.h"
#include "mini_app/core/application/common/permission_policy_manager.h"
#include "content/public/common/url_constants.h"
#include "url/url_util.h"
#include "ui/base/l10n/l10n_util.h"

namespace keys = mini_app::application_manifest_keys;
namespace widget_keys = mini_app::application_widget_keys;
namespace errors = mini_app::application_manifest_errors;
...
void ApplicationData::SetManifestData(const std::string& key,
  ...
  DCHECK(!finished_parsing_manifest_ && thread_checker_.CalledOnValidThread());
  manifest_data_[key] = std::shared_ptr<ManifestData>(data);
}
