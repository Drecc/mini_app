#ifndef MINI_APP_CORE_BROWSER_APP_WINDOW_SIZE_CONSTRAINTS_H_
#define MINI_APP_CORE_BROWSER_APP_WINDOW_SIZE_CONSTRAINTS_H_
...
#endif  // MINI_APP_CORE_BROWSER_APP_WINDOW_SIZE_CONSTRAINTS_H_
