#ifndef MINI_APP_CORE_BROWSER_APP_WINDOW_NATIVE_APP_WINDOW_H_
#define MINI_APP_CORE_BROWSER_APP_WINDOW_NATIVE_APP_WINDOW_H_
...
#endif  // MINI_APP_CORE_BROWSER_APP_WINDOW_NATIVE_APP_WINDOW_H_
