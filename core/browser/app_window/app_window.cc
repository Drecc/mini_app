...
// #include "app_window/browser/extension_system.h"
// #include "app_window/browser/extension_web_contents_observer.h"
// #include "app_window/browser/extensions_browser_client.h"
// #include "app_window/browser/notification_types.h"
// #include "app_window/browser/process_manager.h"
// #include "app_window/browser/suggest_permission_util.h"
// #include "app_window/browser/view_type_utils.h"
// #include "app_window/common/draggable_region.h"
// #include "app_window/common/extension.h"
// #include "app_window/common/extension_messages.h"
// #include "app_window/common/manifest_handlers/icons_handler.h"
// #include "app_window/common/permissions/permissions_data.h"
...
void AppWindow::Init(const GURL& url,
  ...
  window_title_ = new_params.window_title;
...
void AppWindow::AddObserver(Observer* observer) {
  observers_.AddObserver(observer);
}

void AppWindow::RemoveObserver(Observer* observer) {
...
base::string16 AppWindow::GetTitle() const {
  ...
  if (!entry || entry->GetTitle().empty()) {
    title = base::UTF8ToUTF16(window_title_);
  } else {
