#ifndef MINI_APP_CORE_BROWSER_APP_WINDOW_APP_WINDOW_H_
#define MINI_APP_CORE_BROWSER_APP_WINDOW_APP_WINDOW_H_
...
class AppWindow : public content::WebContentsDelegate,
 ...
 public:
  ...
  class Observer : public base::CheckedObserver {
   public:
    virtual void OnAppWindowClose(AppWindow* app_window) {}
   protected:
    ~Observer() override {}
  };
  ...
  // Whether the app window is created by IME app_window.
...
#endif  // MINI_APP_CORE_BROWSER_APP_WINDOW_APP_WINDOW_H_
