...
#include "mini_app/core/browser/ui/app_window_easy_resize_window_targeter.h"
#include "mini_app/core/browser/ui/app_window_frame_view.h"
...
void ChromeNativeAppWindowViewsAura::OnBeforeWidgetInit(
    ...
    views::Widget* widget) {
#if defined(USE_X11)
  std::string app_name = "123";
  // Set up a custom WM_CLASS for app windows. This allows task switchers in
  // X11 environments to distinguish them from main browser windows.
  init_params->wm_class_class = "mini_app_class";
  init_params->wm_class_name = init_params->wm_class_class;
...
ChromeNativeAppWindowViewsAura::CreateNonStandardAppFrame() {
  AppWindowFrameView* frame =
      new AppWindowFrameView(widget(), this, HasFrameColor(),
